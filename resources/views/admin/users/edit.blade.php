...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form id="quickForm" action="{{ url('admin/user/update/'.$u->id) }}" method="POST">
              @csrf
        <div class="row">
          <div class="col-6">
              ...
              <!-- form start -->
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2 @error('role') is-invalid @enderror" name="role">
                    ...
                    <option value="us" {{ $u->role == "us" ? "selected" : "" }}>User</option>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status">
                    <option value="uv" {{ $u->status == "uv" ? "selected" : "" }}>Unverified</option>
